            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav me-auto">
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle {{ request()->routeIs('volunteers.*', 'beneficiaries.*', 'beneficiary-groups.*', 'administrative-regions.*') ? 'active' : '' }}" 
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li><a class="dropdown-item {{ request()->routeIs('beneficiary-groups.*') ? 'active' : '' }}" href="{{ route('beneficiary-groups.index') }}">
                                <i class="fas fa-layer-group me-2"></i>Kelompok Penerima
                            </a></li>
