        ...
        <div class="col-12">
            <div class="modern-card">
                <div class="card-header-modern">
                    ...
                    <p class="card-subtitle-modern">Perbarui informasi penerima bantuan: {{ $beneficiary->name }}</p>
                </div>
                    ...
                    <form action="{{ route('beneficiaries.update', $beneficiary) }}" method="POST">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('family_card_number') is-invalid @enderror" 
                                           ...
                                           value="{{ old('family_card_number', $beneficiary->family_card_number) }}" required>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('national_id') is-invalid @enderror" 
                                           ...
                                           value="{{ old('national_id', $beneficiary->national_id) }}" required>
                                    @error('national_id')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('address') is-invalid @enderror" 
                                      id="address" name="address" rows="3" required>{{ old('address', $beneficiary->address) }}</textarea>
                            @error('address')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                            ...
                            <div class="col-md-2">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('rt') is-invalid @enderror" 
                                           id="rt" name="rt" 
                                           value="{{ old('rt', $beneficiary->rt) }}" required>
                                    @error('rt')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-2">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('rw') is-invalid @enderror" 
                                           id="rw" name="rw" 
                                           value="{{ old('rw', $beneficiary->rw) }}" required>
                                    @error('rw')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-3">
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control @error('age') is-invalid @enderror" 
                                           ...
                                           value="{{ old('age', $beneficiary->age) }}" required>
                                    @error('age')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-5">
                                <div class="mb-3">
                                    ...
                                    <select class="form-control @error('gender') is-invalid @enderror" 
                                        ...
                                        <option value="male" {{ old('gender', $beneficiary->gender) == 'male' ? 'selected' : '' }}>Laki-laki</option>
                                        <option value="female" {{ old('gender', $beneficiary->gender) == 'female' ? 'selected' : '' }}>Perempuan</option>
                                    </select>
                                    @error('gender')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-control @error('kabupaten_id') is-invalid @enderror" 
                                        ...
                                        @foreach($kabupatenList as $kabupaten)
                                            <option value="{{ $kabupaten->id }}" {{ old('kabupaten_id', $beneficiary->kabupaten_id) == $kabupaten->id ? 'selected' : '' }}>
                                                {{ $kabupaten->name }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-control @error('kecamatan_id') is-invalid @enderror" 
                                        ...
                                        @foreach($kecamatanList as $kecamatan)
                                            <option value="{{ $kecamatan->id }}" {{ old('kecamatan_id', $beneficiary->kecamatan_id) == $kecamatan->id ? 'selected' : '' }}>
                                                {{ $kecamatan->name }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-control @error('desa_id') is-invalid @enderror" 
                                        ...
                                        @foreach($desaList as $desa)
                                            <option value="{{ $desa->id }}" {{ old('desa_id', $beneficiary->desa_id) == $desa->id ? 'selected' : '' }}>
                                                {{ $desa->name }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-control @error('beneficiary_group_id') is-invalid @enderror" 
                                        ...
                                        @foreach($beneficiaryGroups as $group)
                                            <option value="{{ $group->id }}" {{ old('beneficiary_group_id', $beneficiary->beneficiary_group_id) == $group->id ? 'selected' : '' }}>
                                                {{ $group->name }}
                                            </option>
                                        @endforeach
                                    </select>
                        ...
                        <div class="mb-3">
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" id="is_active" name="is_active" 
                                       {{ old('is_active', $beneficiary->is_active) ? 'checked' : '' }}>
...
<script>
// Cascading dropdown for administrative regions
$(document).ready(function() {
    $('#kabupaten_id').change(function() {
        ...
        if (kabupatenId) {
            $.get('/volunteers/kecamatan/' + kabupatenId, function(data) {
    ...
    $('#kecamatan_id').change(function() {
        ...
        if (kecamatanId) {
            $.get('/volunteers/desa/' + kecamatanId, function(data) {
                $.each(data, function(key, value) {
