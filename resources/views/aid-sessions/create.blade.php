...
@section('title', 'Buat Sesi Bantuan')
...
<nav aria-label="breadcrumb" class="mb-4">
    <ol class="breadcrumb modern-breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page">
            <i class="fas fa-plus me-1"></i>Buat Sesi Bantuan
        </li>
    </ol>
</nav>
                    ...
                    <div class="col-md-8">
                        <div class="hero-text animate-fade-in-up">
                            <h1 class="hero-title">
                                ...
                                Buat <span class="text-gradient">Sesi Bantuan</span>
                            </h1>
                            <p class="hero-subtitle">Rencanakan Sesi Distribusi Bantuan</p>
                            <p class="hero-description">Buat sesi bantuan baru dengan menentukan periode, jenis bantuan, dan target distribusi</p>
                            <div class="hero-badges">
                                <span class="badge badge-modern">📝 Form Lengkap</span>
                                <span class="badge badge-modern">📅 Periode Fleksibel</span>
        ...
        <div class="modern-card animate-fade-in-up" style="animation-delay: 0.3s;">
            <div class="card-header-modern">
                <h5 class="card-title-modern">
                    ...
                    Form Buat Sesi Bantuan
                </h5>
                <p class="card-subtitle-modern">Lengkapi informasi sesi bantuan yang akan dibuat</p>
            </div>
            <div class="card-body-modern">
                <form action="{{ route('aid-sessions.store') }}" method="POST" id="aidSessionForm">
                    @csrf
                            ...
                            <div class="col-md-12 mb-4">
                                <div class="modern-form-group">
                                    ...
                                    <textarea class="form-control modern-textarea @error('description') is-invalid @enderror" 
                                              ...
                                              name="description" 
                                              rows="4" 
                                              placeholder="Deskripsikan tujuan dan detail sesi bantuan ini...">{{ old('description') }}</textarea>
                                    @error('description')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                    ...
                    <div class="form-section">
                        <div class="section-header">
                            ...
                            <p class="section-subtitle">Tentukan jenis bantuan yang akan didistribusikan</p>
                        </div>

                        <div id="aid-items-container">
                            <!-- Aid items will be added here -->
                        </div>
                    ...
                    <div class="action-buttons-form">
                        <button type="submit" class="btn btn-gradient-primary btn-lg">
                            <i class="fas fa-save me-2"></i>Simpan Sesi Bantuan
                        </button>
...
function toggleNominalField(select) {
    ...
    if (hasNominal) {
        ...
        quantityField.classList.remove('col-md-6');
        quantityField.classList.add('col-md-6');
    } else {
...
// Add first aid item on page load
