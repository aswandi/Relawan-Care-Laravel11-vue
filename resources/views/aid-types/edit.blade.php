...
<nav aria-label="breadcrumb" class="mb-4">
    <ol class="breadcrumb modern-breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page">
            <i class="fas fa-edit me-1"></i>Edit Jenis Bantuan
        </li>
    </ol>
</nav>
                    ...
                    <div class="col-md-8">
                        <div class="hero-text animate-fade-in-up">
                            <h1 class="hero-title">
                                ...
                                Edit <span class="text-gradient">{{ $aidType->name }}</span>
                            </h1>
                            <p class="hero-subtitle">Perbarui Data Jenis Bantuan</p>
                            <p class="hero-description">Modifikasi informasi jenis bantuan untuk menyesuaikan dengan kebutuhan terkini</p>
        ...
        <div class="modern-card animate-fade-in-up" style="animation-delay: 0.3s;">
            <div class="card-header-modern">
                <h5 class="card-title-modern">
                    <i class="fas fa-edit"></i>
                    Form Edit Jenis Bantuan
                </h5>
                <p class="card-subtitle-modern">Perbarui informasi jenis bantuan {{ $aidType->name }}</p>
            </div>
            <div class="card-body-modern">
                <form action="{{ route('aid-types.update', $aidType) }}" method="POST" id="aidTypeForm">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12 mb-4">
                            <div class="modern-form-group">
                                ...
                                <textarea class="form-control modern-textarea @error('description') is-invalid @enderror" 
                                          ...
                                          name="description" 
                                          rows="4" 
                                          placeholder="Deskripsikan jenis bantuan ini secara detail...">{{ old('description', $aidType->description) }}</textarea>
                                @error('description')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                            ...
                            <div class="modern-form-group">
                                ...
                                <div class="modern-switch-container">
                                    <div class="form-check form-switch modern-switch">
                                        <input class="form-check-input" type="checkbox" id="has_nominal" name="has_nominal" value="1" {{ old('has_nominal', $aidType->has_nominal) ? 'checked' : '' }}>
                        ...
                        <div class="col-md-12 mb-4">
                            <div class="modern-form-group">
                                ...
                                <div class="modern-switch-container">
                                    <div class="form-check form-switch modern-switch">
                                        <input class="form-check-input" type="checkbox" id="is_active" name="is_active" value="1" {{ old('is_active', $aidType->is_active) ? 'checked' : '' }}>
                                        <label class="form-check-label" for="is_active">
                                            Ya, jenis bantuan ini aktif dan dapat digunakan
                                        </label>
                                    </div>
                                </div>
                                <small class="form-text text-muted">Centang untuk mengaktifkan jenis bantuan ini dalam sistem</small>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="action-buttons-form">
                        <button type="submit" class="btn btn-gradient-primary btn-lg">
                            <i class="fas fa-save me-2"></i>Update Jenis Bantuan
                        </button>
                        <a href="{{ route('aid-types.show', $aidType) }}" class="btn btn-outline-info btn-lg">
